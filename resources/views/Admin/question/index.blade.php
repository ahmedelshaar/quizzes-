...
@section('content')
    <div class="container-fluid page__heading-container">
        <div
            ...
            <a href="{{ route('question.create') }}" class="btn btn-success ml-lg-3">اضافة سؤال جديد <i
            ...
            <table id="table" class="table table-striped" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button action="{{ route('question.destroy', $question->id) }}" name="{{$question->question}}" data-toggle="modal" data-target="#modal-standard" type="button" class="btn btn-danger delete-item-table">حذف</button>
                    </td>
                </tr>
                @endforeach
                </tbody>
...
<script>
    $(document).ready(function () {
        ...
        $('#modal-standard').on('show.bs.modal', function (event) {
            $(this).find('p').text(`انت تقوم بحذف سؤال: ${event.relatedTarget.name}`)
