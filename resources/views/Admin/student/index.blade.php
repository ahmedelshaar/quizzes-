...
@section('content')
    <div class="container-fluid page__heading-container">
        <div
            ...
            <a href="{{ route('student.create') }}" class="btn btn-success ml-lg-3">اضافة طالب جديد <i
            ...
            <table id="table" class="table table-striped" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button action="{{ route('student.destroy', $student->id) }}" name="{{$student->FullName}}" data-toggle="modal" data-target="#modal-standard" type="button" class="btn btn-danger delete-item-table">حذف</button>
                    </td>
                </tr>
                @endforeach
                </tbody>
...
<script>
    $(document).ready(function () {
        ...
        $('#modal-standard').on('show.bs.modal', function (event) {
            $(this).find('p').text(`انت تقوم بحذف الطالب: ${event.relatedTarget.name}`)
